    ...
    <>
      ...
      <aside className="hidden md:flex w-64 bg-white border-r border-slate-200 flex-col fixed h-screen z-50">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <Link
            href="/"
            className="block px-4 py-2 rounded hover:bg-blue-50 text-slate-900 transition font-medium text-sm"
          >
            Dashboard
          </Link>
          ...
          <div className="mt-6">
            ...
            <Link
              href="/libros"
              className="block px-4 py-2 rounded hover:bg-blue-50 text-slate-900 transition text-sm mt-1"
            >
              Libros
            </Link>
            <Link
              href="/ejemplares"
              className="block px-4 py-2 rounded hover:bg-blue-50 text-slate-900 transition text-sm"
            >
              Ejemplares
            </Link>
          </div>
          ...
          {user.rol_sistema === "ADMINISTRADOR" && (
            <>
              ...
              <div className="mt-6">
                ...
                <Link
                  href="/auditoria"
                  className="block px-4 py-2 rounded hover:bg-blue-50 text-slate-900 transition text-sm mt-1 font-medium text-amber-600"
                >
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-slate-200 text-slate-900 p-4 z-50 shadow-sm">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-base font-bold text-slate-900 truncate max-w-[180px]">
              {user.nombre}
            </h1>

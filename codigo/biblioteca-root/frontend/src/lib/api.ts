const API_URL = "https://backend-gray-one-13.vercel.app";
...
export const ejemplaresApi = {
  ...
  update: (id: number, data: unknown) =>
    apiCall(`/ejemplares/${id}`, "PATCH", data),
...
export const usuariosApi = {
  ...
  update: (id: number, data: unknown) =>
    apiCall(`/usuarios/${id}`, "PATCH", data),
...
export const prestamosApi = {
  ...
  update: (id: number, data: unknown) =>
    apiCall(`/prestamos/${id}`, "PATCH", data),
...
export const usuariosSistemaApi = {
  ...
  update: (id: number, data: unknown) =>
    apiCall(`/usuarios-sistema/${id}`, "PATCH", data),
...
export const categoriasApi = {
  ...
  update: (id: number, data: unknown) =>
    apiCall(`/categorias/${id}`, "PATCH", data),
...
export const editorialesApi = {
  ...
  update: (id: number, data: unknown) =>
    apiCall(`/editoriales/${id}`, "PATCH", data),

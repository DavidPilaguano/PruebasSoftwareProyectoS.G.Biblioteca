...
describe('LibrosController', () => {
    ...
    describe('create', () => {
        it('should call service.create', async () => {
            const dto = { titulo: 'Clean Code', isbn: '123', id_autor: 1, id_editorial: 1, id_categoria: 1 };
            jest.spyOn(service, 'create').mockResolvedValueOnce({ id_libro: 1, ...dto } as any);
    ...
    describe('getDashboardStats', () => {
        it('should return dashboard stats', async () => {
            ...
            jest.spyOn(service, 'getDashboardStats').mockResolvedValueOnce(stats as any);
